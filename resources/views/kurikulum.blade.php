    ...
    <div class="md:w-[70%] w-full">
        ...
        <div class="container mx-auto py-10">
            ...
            <div class="flex flex-col justify-center items-center mx-12">
                <img src="{{ asset('storage/' . $kurikulum->image) }}" alt="{{ $kurikulum->title }}" class="text-center h-1/2 lg:h-96 w-auto mb-9">
                <div class="mx-auto">
                    <h1 class="text-3xl font-bold mb-5">{{ $kurikulum->title }}</h1>
                </div>
                <div class="mx-auto">
                    <p class="mx-auto text-center text-base font-normal">{!! str($kurikulum->description)->sanitizeHtml() !!}</p>
                </div>
            </div>
        </div>
        @endforeach
